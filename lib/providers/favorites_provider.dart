...
final favoritesProvider =
    NotifierProvider<FavoritesNotifier, Map<String, FavoriteEntry>>(
  FavoritesNotifier.new,
);

class FavoritesNotifier extends Notifier<Map<String, FavoriteEntry>> {
  @override
  Map<String, FavoriteEntry> build() {
